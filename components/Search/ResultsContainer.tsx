...
export default function ResultsContainer({
  ...
  if (data.Response == "False" && data.Error == "Too many results." ) return <p className="text-gray-400 text-center text-xl mt-12">Too many results! <br/>Try narrowing your search.</p>;
