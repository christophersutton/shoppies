...
export default function DetailsLineItem({ movie }) {
    const { removeNomination } = useNominations();

    return (

        <li className="bg-white rounded-lg shadow divide-y divide-gray-200 text-green-900 align-left mr-4 ">
            <div className="flex-1 flex flex-col">
                <img src={movie.Poster} className="rounded-t-lg max-w-sm"></img>
                <h4 className="text-lg h-16 p-2">{movie.Title}</h4>
            </div>
            <div className="">
